    ...
    <div className="p-4 bg-white shadow-md">
      <nav className="flex items-center justify-between container mx-auto">
        ...
        <ul className="hidden md:flex space-x-6 text-blue-500">
          <li>
            <Link href="/tippz" className="hover:text-[#053697] cursor-pointer">
              TIPPZ
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/teamz" className="hover:text-[#053697] cursor-pointer">
              TEAMZ
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/store" className="hover:text-[#053697] cursor-pointer">
              STORE
            </Link>
          </li>
        </ul>
